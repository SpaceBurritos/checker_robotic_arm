...
import os
import boardFinder.utils as utils
import boardFinder.debug as debug
import boardFinder.deps as deps
...
__laps_model = os.path.join(dir_path, 'data/models/laps.model.json')
__laps_weights = os.path.join(dir_path, 'data/models/laps.weights.h5')
